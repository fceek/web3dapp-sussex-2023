...
let cocaBtn, costaBtn, oasisBtn, appleBtn
...
function bindModelComponents() {
    ...
    cameraMain = document.querySelector("#Model__CameraMain")
    if (cameraMain.tagName === "Transform")
        cameraMain = cameraMain.firstElementChild
    cameraSide = document.querySelector("#Model__CameraSide")
...
function bindControlComponents() {
    cocaBtn = document.querySelector(".btn-coca")
    costaBtn = document.querySelector(".btn-costa")
    oasisBtn = document.querySelector(".btn-oasis")
    appleBtn = document.querySelector(".btn-apple")
...
function switchModel(target) {
    ...
    setInactive(cocaBtn)
    setInactive(costaBtn)
    setInactive(oasisBtn)
    setInactive(appleBtn)


    switch (target) {
        case "coca":
            setActive(cocaBtn)
            formalName = "Coca Cola"
            break
        case "costa":
            setActive(costaBtn)
            formalName = "Costa Coffee"
            break
        case "oasis":
            setActive(oasisBtn)
            formalName = "Oasis"
        ...
        case "apple":
            setActive(appleBtn)
            formalName = "Appletiser"
            break
    }

    $.ajax({
        type: "POST",
        url: "index.php/apiGetModelInfo",
