...
<nav class="navbar navbar-expand-sm navbar_coca_cola sticky-top">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link nav-a-about" href="javascript:swap('about')">Gallery</a>
            </li>
            <li class="nav-item">
        ...
        <div class="col-sm-4">
            <div class="card">
                <a href="https://www.coca-cola.co.uk/brands/coca-cola-original-taste">
                    <img class="card-img-top img-fluid" src="resources/images/coca_cola.jpg" alt="Coca Cola">
                </a>
                <div class="card-body">
        ...
        <div class="col-sm-4">
            <div class="card">
                <a href="https://www.coca-cola.co.uk/brands/sprite">
                    <img class="card-img-top img-fluid" src="resources/images/sprite.jpg" alt="Sprite">
                </a>
                <div class="card-body">
        ...
        <div class="col-sm-4">
            <div class="card">
                <a href="https://www.coca-cola.co.uk/brands/dr-pepper">
                    <img class="card-img-top img-fluid" src="resources/images/dr_pepper.jpg" alt="Dr Pepper">
                </a>
                <div class="card-body">
        ...
        <div class="col-lg-8">
            <div class="model-selection-wrapper">
                <ul class="nav nav-pills justify-content-center bg-white">
                    <li class="nav-item">
                        <button class="nav-link rounded-5 disabled nav-label">3D Models</button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link active rounded-5 btn-coca" onclick="switchModel('coca')">Coca Cola</button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link rounded-5 btn-costa" onclick="switchModel('costa')">Costa</button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link rounded-5 btn-oasis" onclick="switchModel('oasis')">Oasis</button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link rounded-5 btn-apple" onclick="switchModel('apple')">Appletiser</button>
                    </li>
                </ul>
            </div>
            <div class="x3d-wrapper bg-white">
                <x3d class="x3d-app" showStat="true" max-height="600px">
                    <scene>
                        <inline nameSpaceName="Model" mapDEFToID="true" url="models/coca_final_n.x3d"></inline>
                    </scene>
                </x3d>
            </div>
            <div class="description-text-wrapper bg-white">
                ...
                <div class="model-description-subtitle">
                    <h3>World's Favourite</h3>
                </div>
                <div class="model-description-text">
                    <p>Coca‑Cola is the world’s favourite soft drink and has been enjoyed since 1886. You can find Coca‑Cola in a variety of sizes to suit every lifestyle and occasion.</p>
                </div>
                <div class="model-description-method">
                    <p>Model with 3ds Max, export to VRML97, converted with View3dScene, use vertex colour due to texture problem.</p>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="model-controls-wrapper bg-white">
                ...
                <div class="model-controls-buttons">
                    ...
                    <div class="btn-group" role="group">
                        <button class="btn btn-secondary disabled">Components</button>
                        <button class="btn btn-outline-secondary active btn-mesh-cap" onclick="toggleMesh('Cap')">Cap</button>
                        <button class="btn btn-outline-secondary active btn-mesh-bottle" onclick="toggleMesh('Bottle')">Bottle</button>
                        <button class="btn btn-outline-secondary active btn-mesh-content" onclick="toggleMesh('Content')">Content</button>
                    </div>
                    <div class="btn-group" role="group">
                        <button class="btn btn-secondary disabled">Animation(Appletiser)</button>
...
<nav class="navbar navbar-expand-sm footer">
    <div class="container">
        <div class="navbar-text float-left copyright">
            <p><span class="align-baseline">&copy 2023 Web 3D Applications</span></p>
        </div>
